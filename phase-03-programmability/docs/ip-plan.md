# Phase 3: IP Addressing Plan

## What Changed from Phase 1

- **dist-3 (Nokia SR Linux)** added as a third distribution switch
- **host-devops** added on VLAN 40 (DevOps department)
- **VLAN 40** added across all three distribution switches
- Two new point-to-point links: edge-1 to dist-3, dist-2 to dist-3
- New loopback for dist-3
...
| DIST-3  | 10.0.255.13/32   | Router ID / OSPF RID |
...
### EDGE-1 to DIST-3 (OSPF Area 0) — NEW

| Device | Interface       | IP Address     |
|--------|-----------------|----------------|
| EDGE-1 | eth4            | 10.0.1.13/30   |
| DIST-3 | ethernet-1/1    | 10.0.1.14/30   |

### DIST-2 to DIST-3 (Inter-switch link, OSPF Area 0) — NEW

| Device | Interface       | IP Address     |
|--------|-----------------|----------------|
| DIST-2 | eth5            | 10.0.1.17/30   |
| DIST-3 | ethernet-1/2    | 10.0.1.18/30   |
...
| eth4      | DIST-3 ethernet-1/1  | 10.0.1.13/30     |
...
| eth5      | DIST-3 ethernet-1/2  | 10.0.1.17/30     |
| Vlan10    | -                    | 10.0.10.3/24     |
| Vlan20    | -                    | 10.0.20.3/24     |
| Vlan30    | -                    | 10.0.30.3/24     |
| Vlan40    | -                    | 10.0.40.3/24     |
...
### DIST-3 (Nokia SR Linux — L3 Switch) — NEW

| Interface      | Connects To          | IP Address       |
|----------------|----------------------|------------------|
| ethernet-1/1   | EDGE-1 eth4          | 10.0.1.14/30     |
| ethernet-1/2   | DIST-2 eth5          | 10.0.1.18/30     |
| ethernet-1/3   | HOST-DEVOPS eth1     | Access VLAN 40   |
| irb0.10        | -                    | 10.0.10.4/24     |
| irb0.20        | -                    | 10.0.20.4/24     |
| irb0.30        | -                    | 10.0.30.4/24     |
| irb0.40        | -                    | 10.0.40.4/24     |
| system0        | -                    | 10.0.255.13/32   |

### HOST-ENG (Alpine Linux)

| Interface | Connects To   | IP Address                      |
|-----------|---------------|---------------------------------|
| eth1      | DIST-1 eth3   | 10.0.10.100/24 (gw: 10.0.10.2) |

### HOST-SALES (Alpine Linux)

| Interface | Connects To   | IP Address                      |
|-----------|---------------|---------------------------------|
| eth1      | DIST-2 eth3   | 10.0.20.100/24 (gw: 10.0.20.3) |

### HOST-SERVER (Alpine Linux)

| Interface | Connects To   | IP Address                      |
|-----------|---------------|---------------------------------|
| eth1      | DIST-2 eth4   | 10.0.30.100/24 (gw: 10.0.30.3) |

### HOST-DEVOPS (Alpine Linux) — NEW

| Interface | Connects To          | IP Address                      |
|-----------|----------------------|---------------------------------|
| eth1      | DIST-3 ethernet-1/3  | 10.0.40.100/24 (gw: 10.0.40.4) |

## VLAN Subnets

| VLAN | Name        | Subnet          | DIST-1 IP   | DIST-2 IP   | DIST-3 IP   |
|------|-------------|-----------------|-------------|-------------|-------------|
| 10   | Engineering | 10.0.10.0/24    | 10.0.10.2   | 10.0.10.3   | 10.0.10.4   |
| 20   | Sales       | 10.0.20.0/24    | 10.0.20.2   | 10.0.20.3   | 10.0.20.4   |
| 30   | Servers     | 10.0.30.0/24    | 10.0.30.2   | 10.0.30.3   | 10.0.30.4   |
| 40   | DevOps      | 10.0.40.0/24    | 10.0.40.2   | 10.0.40.3   | 10.0.40.4   |
...
| 10.0.1.12/30    | EDGE-1 to DIST-3 (new)     |
| 10.0.1.16/30    | DIST-2 to DIST-3 (new)     |
| 10.0.10.0/24    | VLAN 10 — Engineering      |
| 10.0.20.0/24    | VLAN 20 — Sales            |
| 10.0.30.0/24    | VLAN 30 — Servers          |
| 10.0.40.0/24    | VLAN 40 — DevOps (new)     |
